...
def collate_fn_descriptor(list_data, config, neighborhood_limits):
    ...
    for ind, (src_pcd,tgt_pcd,src_feats,tgt_feats,rot,trans,matching_inds, src_pcd_raw, tgt_pcd_raw, src_nghb, tgt_nghb, sample) in enumerate(list_data):
    ...
    dict_inputs = {
        ...
        'src_nghb': torch.from_numpy(src_nghb).float(),
        'tgt_nghb': torch.from_numpy(tgt_nghb).float(),
        'sample': sample
    }
