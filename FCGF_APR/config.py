...
net_arg.add_argument('--generator_model', type=str, default='ResUNetBN2C')
...
net_arg.add_argument('--point_generation_ratio', type=int, default=6)
net_arg.add_argument('--regularization_strength', type=float, default=0.1)
net_arg.add_argument('--regularization_type', type=str, default='L2')
...
debug_arg.add_argument('--symmetric', type=str2bool, default=False)
