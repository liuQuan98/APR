...
export GENERATOR_MODEL=${MODEL:-GenerativeMLP_98}
...
# export RESUME_FILE="./outputs/Experiments/PairComplementKittiDataset-v0.3/GenerativePairTrainer//SGD-lr1e-1-e200-b4i1-modelnout128/2022-12-18_12-23-19/checkpoint.pth"
# export RESUME_DIR="./outputs/Experiments/PairComplementKittiDataset-v0.3/GenerativePairTrainer//SGD-lr1e-1-e200-b4i1-modelnout128/2022-12-18_12-23-19"
