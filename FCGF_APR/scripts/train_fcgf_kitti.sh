...
# export RESUME_FILE="./outputs/Experiments/PairComplementKittiDataset-v0.3/HardestContrastiveLossTrainer//SGD-lr1e-1-e200-b4i1-modelnout32/2023-02-13_19-48-37/checkpoint.pth"
# export RESUME_DIR="./outputs/Experiments/PairComplementKittiDataset-v0.3/HardestContrastiveLossTrainer//SGD-lr1e-1-e200-b4i1-modelnout32/2023-02-13_19-48-37"
